...
/**
 * Quick function that illustrates snapping to a line.断点成线的方法
 *
 * @author jody
 */
public class SnapFunction implements Function {
    ...
    static FunctionName NAME =
            new FunctionNameImpl(
                    ...
                    FunctionNameImpl.parameter("line", Geometry.class));//函数名

    private final List<Expression> parameters;//参数

    private final Literal fallback;//返回值
